...
public class AssociateBOINCActivity extends BRActivity {
    ...
    private CheckBox checkUnbanked;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkUnbanked = (CheckBox) findViewById( R.id.checkUnbanked);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if ( CPID != "" ) {
                        ...
                        String sUnbanked = (checkUnbanked.isChecked())?"1":"0";
                        String Data = CPID + ";" + hexKey + ";" + decorated + ";" + rID + ";;" + sUnbanked ;       // unbanked always
